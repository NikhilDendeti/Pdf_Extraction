...
# import os
# import json
# from utils import DocumentIntelligenceSystem  
...
#     print(f"📄 Found {len(pdf_paths)} PDF file(s): {[os.path.basename(p) for p in pdf_paths]}")
...
#     print(f"📊 Processed {len(pdf_paths)} document(s) in {result['metadata']['processing_time_seconds']} seconds")
